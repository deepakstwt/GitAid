...
/**
 * Clerk's <SignUp> is loaded dynamically with ssr:false.
 * The page shell (background, branding) renders instantly while
 * the Clerk bundle loads as a separate async chunk.
 */
