...
/**
 * Clerk's <SignIn> is a large client-side component (~1,300 modules).
 * Loading it dynamically with ssr:false means:
 * 1. The page shell renders instantly (background, branding header)
 * 2. The Clerk bundle is fetched in parallel as a separate chunk
 * 3. No synchronous compilation block on first request
 */
    ...
    () => import('@clerk/nextjs').then((m) => m.SignIn),
    {
        ...
        loading: () => (
            <div className="w-full max-w-md mx-auto">
                <div className="rounded-3xl border border-white/10 bg-gray-900/90 p-8 animate-pulse">
                    <div className="h-8 bg-white/10 rounded-lg mb-4 w-2/3 mx-auto" />
                    <div className="h-4 bg-white/5 rounded mb-8 w-1/2 mx-auto" />
                    <div className="h-12 bg-white/10 rounded-xl mb-3" />
                    <div className="h-4 bg-white/5 rounded mb-6 w-1/3 mx-auto" />
                    <div className="h-12 bg-white/5 rounded-xl mb-3" />
                    <div className="h-12 bg-white/5 rounded-xl mb-4" />
                    <div className="h-12 bg-indigo-600/40 rounded-xl" />
                </div>
            </div>
        ),
    }
